...
KKTC'de ruhsatlı 39 sigorta şirketini, **dışarıdan doğrulanabilen** ölçütlerde karşılaştırıyoruz —
ve doğrulayamadığımız yeri boş bırakıyoruz.

## Okur kim

Üç ayrı kitle, tek site:
...
2. Kaynak bloğu (sayfa altı)
3. Doğrulanamayan her rakamın yerine **neden boş olduğunun açıklaması**
4. "Sigorta tavsiyesi değildir" ayak notu

---

## ⛔ ASLA YAZILMAYACAKLAR

Bu liste araştırma dosyasındaki doğrulanmamış bulgulardan çıkarıldı.
Bunlardan birini yazmak sitenin tek iddiasını çürütür.
...
| Hasar ödeme performansı / "en çok ödeyen şirket" | Hiçbir yılda ödenen hasar sıralaması bulunamadı. |
| MAPFREE ile İspanyol MAPFRE bağlantısı | Kanıt yok, yazım da farklı. |
| London Insurance / Limasol Sigorta'nın yabancı grup bağı | Doğrulanmadı. |
...
## ⚠ Yazılabilir ama etiketlenmesi şart

| Bilgi | Etiket |
|---|---|
| Kasko €300–500/yıl | "ticari kaynak, resmî değil" |
| Acente ağı büyüklüğü (örn. Şeker "90 acente") | "şirket beyanı" |
| Öğrenci sağlık primi = asgari ücretin %10'u | "tutar teyit edilmeli" |
...
## Sürekli tekrarlanan üç ayrım

Rakip içeriklerin hata yaptığı üç nokta. Her ilgili sayfada net yapılır:

1. **KKTC ≠ Türkiye.** Limit, ceza, düzenleyici, tarife rejimi, şikâyet mercii — hepsi ayrı.
...
## Terim sözlüğü (çeviride sabit kalır)

| TR | EN | Not |
|---|---|---|
| Zorunlu trafik sigortası | Compulsory third-party motor insurance | "MTPL" kısaltması kullanılabilir |
| Kasko | Comprehensive motor insurance | "Kasko" parantez içinde korunur |
| Taban tarife | Minimum tariff / floor tariff | |
| Hasarsızlık indirimi | No-claims discount | |
| Garanti Fonu | Guarantee Fund | |
| Sigorta Tahkim Komisyonu | Insurance Arbitration Commission | KKSRSB bünyesinde |
| Para, Kambiyo ve İnkişaf Sandığı İşleri Dairesi | Department of Money, Exchange and Development Fund Affairs | İlk geçişte tam ad |
| Fasıl 333 | Chapter 333 | Yasa adı çevrilmez, açıklanır |
| Sağlık Fonu | Health Fund | "not private insurance" ibaresiyle |
| Muallak hasar | Outstanding claims | Ödenen hasar DEĞİL |

Kurum adları çevrilmez, ilk geçişte açıklanır: KKSRSB, KKSBM.
Para birimi: TL sitede **₺**, EUR **€**. Ondalık ayırıcı TR'de virgül, EN'de nokta.
